...
typedef enum {
  ...
  LP_COMMAND_SET_BUTTON_LED = 0x06,
} lp_command_t;

#define LP_IDENTIFY_DURATION_SECONDS 4U
typedef enum {
  LP_BUTTON_LED_STANDBY = 0,
  LP_BUTTON_LED_READY = 1,
  LP_BUTTON_LED_BLOCKED = 2,
} lp_button_led_state_t;
